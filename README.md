...
docs/USER_MANUAL.md        user manual (the source)
docs/manual/index.html     the manual as a web page, generated by tools/build-docs.js. Never edit by hand
tools/build-docs.js        dependency-free Markdown converter for the manual
...
npm run build     rebuild index.html from src/, and the manual page
npm run build:docs   rebuild docs/manual/index.html from docs/USER_MANUAL.md
```
